...
if __name__ == '__main__':
    ...
    parser.add_argument("input", help="genome_ref_taxid.json file")  
    parser.add_argument("output", help="jsontree.json")
    args = parser.parse_args()
    Dict=json.load(open(args.input,'r'))	##This Dictionary contains as keys the names of all the bacterial genomes in the database.
    ncbi = NCBITaxa()
    allspe = []
    list_ID=[]
    invert_dic={}
